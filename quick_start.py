...
def quick_start():
    ...
    LOCAL_ZIP_FILE = os.path.join(os.path.dirname(__file__), 'target/managed-flink-pyfink-msk-iceberg.zip')
    ...
    try:
        ...
        s3_url = manager.upload_to_s3(zip_file, S3_BUCKET, S3_KEY, SUBNET_ID,SG_ID)
